        ...
        <PageLoader isLoadFinished={isLoadFinished}>
            <StyledRoot initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 1.0 }}>
                <Page>
                    ...
                    <LayoutContent>
                        <LayoutTextSection>
                            <GlitchText text={"I'm a frontend " + "developer based in Munich. "} variant={"color"} />
                        ...
                        <LayoutTextSection>
                            <GlitchText text={"Born 1990 in Bad Windsheim."} variant={"color"} />

                            <Spacer size={"xsmall"} />

                            <GlitchText text={"School years in Höchstadt a.d. Aisch (close to Nuremberg)."} variant={"color"} />
                        </LayoutTextSection>
